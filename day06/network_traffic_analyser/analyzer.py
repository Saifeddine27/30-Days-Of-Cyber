...
if iface_choice and iface_choice.isdigit() and 1 <= int(iface_choice) <= len(interfaces):
...
try:
    count = int(input("How many packets to capture: ").strip())
except ValueError:
    print("Invalid number. Defaulting to 100 packets.")
    count = 100
